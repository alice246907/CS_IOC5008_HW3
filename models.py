...
class YOLOLayer(nn.Module):
    ...
    def forward(self, x, targets=None, img_dim=None):
        ...
        if targets is None:
            ...
            # noobj_mask, tx, ty, tw, th, tcls, tconf = build_targets(
            build_targets_data = build_targets(
            ...
            iou_scores = build_targets_data[0]
            class_mask = build_targets_data[1]
            obj_mask = build_targets_data[2]
            noobj_mask = build_targets_data[3]
            tx = build_targets_data[4]
            ty = build_targets_data[5]
            tw = build_targets_data[6]
            th = build_targets_data[7]
            tcls = build_targets_data[8]
            tconf = build_targets_data[9]
...
class Darknet(nn.Module):
    ...
    def save_darknet_weights(self, path, cutoff=-1):
        """
            @:param path    -
            path of the new weights file
            @:param cutoff  -
            save layers between 0 and cutoff
