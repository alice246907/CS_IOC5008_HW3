...
def non_max_suppression(prediction, conf_thres=0.5, nms_thres=0.4):
    """
    Removes detections with lower object confidence score
    than 'conf_thres' and performs
    ...
    for image_i, image_pred in enumerate(prediction):
        ...
        while detections.size(0):
            ...
            # Indices of boxes with lower confidence scores,
            # large IOUs and matching labels
